      ...
      <div id="colorPickerContainer" class="hidden">
        ...
        <div class="bg-white rounded-lg shadow-lg p-4 text-gray-700 text-sm">
          <button type="button" id="enable_png_btn"
            class="text-white hover:text-white border border-red-700 bg-reg-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
